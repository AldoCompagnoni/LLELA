...
# Number of male flowers per plot
...
# plot level number of flowers and flower sex ratio
...
fert$fertility       <- fert$n_flowers_f * fert$pred_percapita_seeds * fert$pred_viab 
...
z<-matrix(fert$fertility, nrow=length(unique(fert$sr)),
