...
# 2015 --------------------------------------------------------------------------
plot(d15$new_t1,d15$l_t1, pch=16, ylab="Number of target leaves (2015)",
...
# Density
plot(d15$TotDensity,d15$l_t1, pch=16, ylab="Number of target leaves (2015)",
...
plot(d14$c_t0, d14$l_t1, pch=16, ylab="Number of target leaves (2014)",
     xlab="Total number of plot leaves",col=d14$col, ylim = c(0,82))
...
# Planting density
plot(d14$TotDensity, d14$l_t1, pch=16, ylab="Number of target leaves (2014)",
     xlab="Planting density",col=d14$col, ylim = c(0,82))
